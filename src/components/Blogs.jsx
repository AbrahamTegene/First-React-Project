...
const Blogs = () => {
    const blogs = [
           ...
           { id:1, title: "Creating Streamlined Safeguarding Processes with OneRen" , image:"src/assets/blog.png"},
           { id:2, title: "What are your safeguarding responsibilities and how can you manage them?" , image:"src/assets/blog1.png" },
           { id:3, title: "Revamping the Membership Model with Triathlon Australia" , image:"src/assets/blog2.png"},
    ...
    return(
        ...
        <div className="text-center md:w-1/2 mx-auto">
            <h2 className='text-4xl text-neutralDGrey font-semibold mb-4 '>Caring is the new marketing</h2>
             ...
             {/* all blogs */}
             <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-8 justify-between items-center">
                {
                    blogs.map(blog => <div key={blogs.id} 
                          className="mx-auto  relative  mb-12 cursor-pointer">
                        <img src={blog.image} alt="" className="hover:scale-95 transition-all duration-300"/>
                        <div 
                        className="text-center px-4 py-8 bg-white shadow-lg rounded-md md:w-3/4 
